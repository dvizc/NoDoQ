...
const MAX_DEPTH = 32;
const SemaphoreABI = _interface.abi;
const SemaphoreBytecode = _interface.bytecode;

var constants = /*#__PURE__*/Object.freeze({
    __proto__: null,
    MAX_DEPTH: MAX_DEPTH,
    MIN_DEPTH: MIN_DEPTH,
    SemaphoreABI: SemaphoreABI,
    SemaphoreBytecode: SemaphoreBytecode
});
...
function decodeMessage(message) {
    return abi$1.decodeBytes32String(utils.toBeHex(message, 32));
}
